...
app = App(title="Cool Air Controller", width=480, height=320, layout="grid")
frost_picture = Picture(app, image="frost.png", grid=[3,0], height=picture_size, width=picture_size)
motor_button = PushButton(app, command=motor_button_clicked, text="Motor speed", grid=[0, 0], width=button_width, height=element_height)
motor_text = Text(app, text=motor_speed_text[motor_speed], grid=[1, 0], size=font_size)
pump_button = PushButton(app, command=pump_button_clicked, text="Pump", grid=[0, 1], width=button_width, height=element_height)
pump_text = Text(app, text=pump_state_text[pump_state], grid=[1, 1], size=font_size)
cancel_hold_button = PushButton(app, command=cancel_hold_button_clicked, text="cancel", enabled=False, grid=[0, 2], width=button_width, height=element_height)
time_text = Text(app, text=str("Current time:\n" + datetime.now().strftime("%H:%M")), grid=[1, 2], width=text_width, height=element_height, size=font_size)
time_subs_button = PushButton(app, command=time_subs_button_clicked, text="-", enabled=False, grid=[2, 2], width=time_button_width, height=element_height)
time_add_button = PushButton(app, command=time_add_button_clicked, text="+", grid=[3, 2], width=time_button_width, height=element_height)
